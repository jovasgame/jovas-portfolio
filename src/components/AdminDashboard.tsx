    ...
    reader.onload = (event) => {
      try {
        ...
        if (data && data.projects && Array.isArray(data.projects)) {
          localStorage.setItem('jovas_portfolio_v4_clean_projects', JSON.stringify(data.projects));
          if (data.photos) localStorage.setItem('jovas_portfolio_v4_clean_photos', JSON.stringify(data.photos));
          if (data.profile) localStorage.setItem('jovas_portfolio_v4_clean_profile', JSON.stringify(data.profile));
          if (data.brandAssets) localStorage.setItem('jovas_portfolio_v4_clean_brand_assets', JSON.stringify(data.brandAssets));
          if (data.stats) localStorage.setItem('jovas_portfolio_v4_clean_stats', JSON.stringify(data.stats));
